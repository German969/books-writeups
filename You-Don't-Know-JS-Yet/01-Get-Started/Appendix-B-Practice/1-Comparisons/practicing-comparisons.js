// scheduleMeeting(..) should take a start time (in 24-hour format as string "hh:mm")
...
// Consider the usage of equality and relational comparison operators, and how coercion
// impacts this code.